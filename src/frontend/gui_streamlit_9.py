...
import torch
import clip
from similarity_utils import cosine_similarity, process_uploaded_image, process_text_input, find_similar_keyframes, get_all_keyframes
...
if uploaded_file is not None:
    ...
    target_vector = process_uploaded_image(uploaded_file, model, preprocess, device)
...
if text_input:
    target_vector = process_text_input(text_input, model, device)
    all_keyframes = get_all_keyframes()
    similar_keyframes = find_similar_keyframes(target_vector, all_keyframes)
