...
def analyze_and_store_image_from_db():
    ...
    # Encode the concatenated embedding as a base64 string
    concatenated_embedding_str = base64.b64encode(concatenated_embedding).decode('utf-8')
    ...
    cursor.execute('''
        ...
        WHERE id = ?
    ''', (concatenated_embedding_str, keyframe_id))
